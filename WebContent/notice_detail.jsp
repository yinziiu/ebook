...
<title>公告详情页面</title>
<link type="text/css" rel="stylesheet" href="${ pageContext.request.contextPath }/css/notice_detail.css">
</head>
<style type="text/css">
			...
			<div id="newnotice">
				...
				<ul>
					<c:forEach items="${newnotice }" var="notice">
						<li><a href="shownoticedetail?noticeId=${notice.noticeId }">${notice.title }</a></li>
					</c:forEach>
				</ul>
			</div>
			<div id="sousuo">
